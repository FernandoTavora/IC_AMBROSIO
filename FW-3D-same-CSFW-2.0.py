...
# Quantidade de folhas e espaçamento
    ...
    # Distribuição para 4 folhas centradas
...
# Corte 2D de cada Folha de Luz
    ...
    for i, y_plane in enumerate(folhas_y):
        # Extrai a matriz matemática ignorando a renderização 3D
        im = axes2d[i].imshow(
    ...
    plt.suptitle("Tomografia", fontweight='bold', fontsize=14)
    plt.tight_layout()
    plt.show()
