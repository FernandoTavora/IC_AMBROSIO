...
def simular_cvfw_3D_multiplas(lista_img_paths):
    ...
    # Configuração das folhas (O número de folhas agora depende da quantidade de imagens)
    n_folhas = len(lista_img_paths)
    espaco_y = 35e-6

    # Cálculo universal para centralizar as N folhas
...
# Processamento de multiplas imagens
    lista_f_matrices = []
...
# Folhas de luz
    for idx_plano, plano_y in enumerate(folhas_y):  # Plano de observação atual
        ...
        # plano de observação (plano_y). O crosstalk entre planos esta desconsiderado.
        yp = plano_y

        # Seleciona a matriz morfológica exata correspondente a esta folha
        ...
        for p in range(nx):
            ...
            # Como plano_y == yp, a diferença será sempre zero.
            # O cálculo se restringe ao eixo central puro da onda contínua.
...
# esfera fatiada em 9 partes
minhas_imagens = [
    "esfera_9_fatias_1.png",
    "esfera_9_fatias_2.png",
    "esfera_9_fatias_3.png",
    "esfera_9_fatias_4.png",
    "esfera_9_fatias_5.png",
    "esfera_9_fatias_6.png",
    "esfera_9_fatias_7.png",
    "esfera_9_fatias_8.png",
    "esfera_9_fatias_9.png"
]
